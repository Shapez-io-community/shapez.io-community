...
export class HUDBuildingPlacer extends HUDBuildingPlacerLogic {
    ...
    rerenderInfoDialog() {
        ...
        let Tl = (T.buildings[metaBuilding.id] || {})[variant] || {};
        this.buildingInfoElements.label.innerHTML = Tl.name;
        this.buildingInfoElements.descText.innerHTML = Tl.description;
